...
function updateStats() {
    ...
    Clock = Math.pow(2, player.level.blue[0]) / (player.spectrumLevel[9] == 1 ? 1024 : 1);
    ...
    price.blue[3] = 1048576 * Math.pow(Math.pow(512,Math.floor(player.level.blue[3]/5)+1), player.level.blue[3]) * (Math.pow(128,));
